...
// checkUser runs on every GET — loads user, exp, approved_que for all views
...
router.post("/Interview-Prep", requireAuth, prepController.question_post);
...
router.post("/add", requireAuth, adminController.add_post);
router.get("/remove", requireAuth, checkAdmin, provideUsers, adminController.remove_get);
router.post("/remove", requireAuth, adminController.remove_post);
router.get("/approve_que", requireAuth, checkAdmin, adminController.appr_que_get);
router.post("/approve_que", requireAuth, adminController.approve_que_post);
router.post("/reject_que", requireAuth, adminController.reject_que_post);
router.get("/approve_exp", requireAuth, checkAdmin, provideUsers, adminController.appr_exp_get);
router.post("/approve_exp", requireAuth, adminController.appr_exp_post);
router.get("/na", requireAuth, adminController.notAdmin_get);

// Interview Experience routes — require login
router.get("/interview-exp", requireAuth, expController.exp_get);
router.post("/interview-exp", requireAuth, expController.exp_post);
router.get("/interview-exp/:company", requireAuth, provideUsers, expController.expInner_get);
